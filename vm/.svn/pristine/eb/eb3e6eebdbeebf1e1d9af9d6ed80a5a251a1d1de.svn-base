...
<article class="page-container">
	...
	<div class="row cl">
	 ...
	 <div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9" style="width:250px;">
			<select id="city" class="input-text" name="pointCity">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9" style="width:250px;">
			<select id="area" class="input-text" name="pointDistrict">
			    <option value="0">请选择</option>
			</select>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9" style="width:250px;">
			<select id="channelName" name="ChannelId" class="input-text">
			</select>
		</div>
	</div>
	<div class="row cl">
