	...
	*/
	function build_roles_table(result){
		...
		$.each(equipmentlist,function(index,item){
					...
					var equipmentNumber = $("<td></td>").css("text-align","center");
					var equipmentName = $("<td></td>").css("text-align","center");
					if (eqList) {
					$.each(item.eqList,function(index,e){
						equipmentNumber.append(e.equipmentNumber);
						equipmentName.append(e.equipmentName);
					})
					}else{
						equipmentNumber.append("-");
