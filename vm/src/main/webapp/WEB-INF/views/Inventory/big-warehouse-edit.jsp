...
<article class="page-container">
	<form class="form form-horizontal" id="form-bigware-update">
	...
	<div class="row cl">
		<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
			<input class="btn btn-primary radius" id="update_bigware" type="button" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
		</div>
	</div>
	</form>
</article>
...
$(function(){
		...
		$.ajax({
			url:"${APP_PATH}/getBigwareById",
			data:{"bigWarehouseId":bigWarehouseId},
			type:"GET",
			success:function(result){
				var bigware = result.extend.list;
				$.each(bigware,function(index,b){
					$("#bigWarehouseName").val(b.bigWarehouseName);
					$("#bigWarehouseAddress").val(b.bigWarehouseAddress);
					
/* 					$.each(b.areas,function(index,area){
						if(area.type == 1){
		...
		$("#update_bigware").click(function(){
			$.ajax({
				url: "${APP_PATH}/EditBigware",
				type: 'POST',
				data: $("#form-bigware-update").serialize(),
				async:false,
				success: function(result){
					if (result.code == 100) {
