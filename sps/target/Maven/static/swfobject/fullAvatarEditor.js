function fullAvatarEditor() {
	...
	var file			= 'static/swfobject/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= 'static/swfobject/expressInstall.swf';			//expressInstall.swf的路径
	...
	for(var i = 0; i < arguments.length; i++)
	{
		...
		if(typeof a == 'string')
		{
			if (a.substring(a.length - 'static/swfobject/fullAvatarEditor.swf'.length) == 'static/swfobject/fullAvatarEditor.swf')
			{
				file = a;
			}
			else if (a.substring(a.length - 'static/swfobject/expressInstall.swf'.length) == 'static/swfobject/expressInstall.swf')
			{
				expressInstall = a;
			}
			else
