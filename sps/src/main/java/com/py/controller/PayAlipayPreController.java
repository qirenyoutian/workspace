...
public class PayAlipayPreController {
	...
	*@throws AlipayApiException  ModelAndView
	 */
	 @ResponseBody
	 @RequestMapping(value="api/alipay/createOrder",method={RequestMethod.GET})
	 public Msg alipay(
	    ...
	    try {
	        ...
	        model.setOutTradeNo(String.valueOf(tradingRecord.getTradingRecordId()));          			//商户订单号(自动生成)
	 ...
	 public String notify(HttpServletRequest request,HttpServletResponse response) throws IOException {  
	     ...
	     if (signVerified) {    //验签通过   
	         if(tradeStatus.equals("TRADE_SUCCESS")) {    //只处理支付成功的订单: 修改交易表状态,支付成功
	        	 ...
	        	 user.setUserBalance(user.getUserBalance() + tradingRecord.getTradingRecordPrice());
